...
class EnanaTest extends TestCase {
    ...
    public function testHeridaLeveVive() {
        ...
        $enana = new Enana("Antonia",20,"viva");
        $this->assertEquals(10,$enana->heridaLeve());
        $this->assertEquals('viva',$enana->heridaLeveSituacion());
    ...
    public function testHeridaLeveMuere() {
        ...
        $enana = new Enana("Antonia",-10,"limbo");
        $this->assertEquals(-20,$enana->heridaLeve());
        $this->assertEquals('muerta',$enana->heridaLeveSituacion());
    ...
    public function testHeridaGrave() {
        ...
        $enana = new Enana("Antonia",70,"viva");
        $this->assertEquals(0,$enana->heridaGrave());
        $this->assertEquals('limbo',$enana->heridaGraveSituacion());
    ...
    public function testPocimaRevive() {
        ...
        $enana = new Enana("Antonia",-7,'muerta');
        $this->assertEquals(3,$enana->pocima());
        $this->assertEquals('viva',$enana->pocimaSituacion());
    ...
    public function testPocimaExtraLimbo() {
        ...
        $enana = new Enana("Antonia",0,'limbo');
        $this->assertEquals(50,$enana->pocimaExtra());
        $this->assertEquals('viva',$enana->pocimaExtraSituacion());
